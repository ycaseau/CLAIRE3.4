// interface defination for module Reader, Sun Sep 29 07:16:36 2013
...
extern void  addLog_integer(int i,double x,double y,double n,int s);
extern void  addLog_integer_(int g0127,OID g0128,OID g0129,OID g0130,int g0131);
