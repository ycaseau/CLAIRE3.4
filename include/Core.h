// interface defination for module Core, Sun Sep 29 07:16:30 2013
#ifndef CLAIREH_Core
#define CLAIREH_Core
...
extern int  abs_integer(int x);
extern int  random_integer2(int a,int b);
...
extern OID  _plus_float_(OID g0074,OID g0075);
extern double  _dash_float(double self,double x);
extern OID  _dash_float_(OID g0076,OID g0077);
extern double  _star_float(double self,double x);
extern OID  _star_float_(OID g0078,OID g0079);
extern double  _7_float(double self,double x);
extern OID  _7_float_(OID g0080,OID g0081);
extern double  _dash_float2(double self);
extern OID  _dash_float2_(OID g0082);
extern double  sqrt_float(double self);
extern OID  sqrt_float_(OID g0083);
extern double  _exp_float(double self,double x);
extern OID  _exp_float_(OID g0084,OID g0085);
extern double  log_float(double self);
extern OID  log_float_(OID g0086);
extern double  sin_float(double self);
extern OID  sin_float_(OID g0087);
extern double  cos_float(double self);
extern OID  cos_float_(OID g0088);
extern double  atan_float(double self);
extern OID  atan_float_(OID g0089);
extern char * string_I_float(double self);
extern char * string_I_float_(OID g0090);
extern double  abs_float(double x);
extern OID  abs_float_(OID g0091);
extern void  printFDigit_float(double x,int i);
extern void  printFDigit_float_(OID g0092,int g0093);
extern void  printFDigit_integer(int x,int i);
...
extern OID  random_bag(bag *self);
extern ClaireType * random_bag_type(ClaireType *self);
...
extern ClaireBoolean * random_boolean(ClaireBoolean *b);
...
property * printFDigit;// mClaire/"printFDigit"
