...
// definition of the properties 
  ...
  Reader.sqr = property::make("sqr",claire.it);
  Reader.m_index = property::make("m_index",Reader.it);
  Reader.sum_value = property::make("sum_value",Reader.it);
  Reader.sum_square = property::make("sum_square",Reader.it);
  Reader.num_value = property::make("num_value",Reader.it);
  Reader.mean = property::make("mean",claire.it);
  Reader.stdev = property::make("stdev",claire.it);
  Reader.stdev_Z = property::make("stdev%",claire.it);
  Reader.reset = property::make("reset",claire.it);
  Reader.logMeasure = property::make("logMeasure",claire.it);
  Reader.addLog = property::make("addLog",claire.it);
  ...
  Reader.nextunit->addMethod(list::domain(1,Reader._meta_reader),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(nextunit_meta_reader,"nextunit_meta_reader"));
  
  Reader.nexts->addMethod(list::domain(2,Reader._meta_reader,Kernel._keyword),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(nexts_meta_reader,"nexts_meta_reader"));
  
  Reader.loopexp->addMethod(list::domain(4,Reader._meta_reader,
    Kernel._any,
    Kernel._keyword,
    Kernel._boolean),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(loopexp_meta_reader,"loopexp_meta_reader"));
  
  Reader.extended_operator->addMethod(list::domain(3,Kernel._property,Kernel._any,Kernel._any),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(extended_operator_property,"extended_operator_property"));
  ...
  Reader.nexti->addMethod(list::domain(2,Reader._meta_reader,Kernel._any),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(nexti_meta_reader,"nexti_meta_reader"));
  ...
  Reader.nextvariable->addMethod(list::domain(2,Reader._meta_reader,Kernel._any),Kernel._any,
  	NEW_ALLOC,_function_(nextvariable_meta_reader,"nextvariable_meta_reader"));
  ...
  Reader.combine->addMethod(list::domain(3,Kernel._any,Kernel._any,Kernel._any),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(combine_any,"combine_any"));
  
  Reader.combine_I->addMethod(list::domain(3,Kernel._any,Kernel._any,Kernel._any),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(combine_I_any,"combine!_any"));
  ...
  Reader.operand_I->addMethod(list::domain(2,Kernel._any,Kernel._integer),Kernel._any,
  	NEW_ALLOC+SLOT_UPDATE,_function_(operand_I_any,"operand!_any"));
  ...
  Reader.readlet_star->addMethod(list::domain(4,Reader._meta_reader,
    ...
    Kernel._keyword),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(readlet_star_meta_reader,"readlet*_meta_reader"));
  ...
  Reader.readset->addMethod(list::domain(2,Reader._meta_reader,Kernel._any),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(readset_meta_reader,"readset_meta_reader"));
  ...
  Reader.readblock->addMethod(list::domain(3,Reader._meta_reader,Kernel._any,Kernel._integer),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(readblock_meta_reader,"readblock_meta_reader"));
  
  Reader.Do_I->addMethod(list::domain(2,Kernel._any,Kernel._any),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(Do_I_any,"Do!_any"));
  ...
  Reader.skipc->addMethod(list::domain(1,Reader._meta_reader),Kernel._any,
  	0,_function_(skipc_meta_reader,"skipc_meta_reader"));
  
  Reader.skipc_I->addMethod(list::domain(1,Reader._meta_reader),Kernel._any,
  	SLOT_UPDATE,_function_(skipc_I_meta_reader,"skipc!_meta_reader"));
  ...
  Reader.findeol->addMethod(list::domain(1,Reader._meta_reader),Kernel._boolean,
  	0,_function_(findeol_meta_reader,"findeol_meta_reader"));
  ...
  Reader.verify->addMethod(list::domain(3,Kernel._any,Kernel._any,Kernel._any),Kernel._any,
  	NEW_ALLOC,_function_(verify_any,"verify_any"));
  ...
  Reader.extract_variable->addMethod(list::domain(1,Kernel._any),Language._Variable,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(extract_variable_any,"extract_variable_any"));
  
  Reader.bind_I->addMethod(list::domain(2,Reader._meta_reader,Language._Variable),Kernel._list,
  	NEW_ALLOC,_function_(bind_I_meta_reader,"bind!_meta_reader"));
  
  Reader.unbind_I->addMethod(list::domain(2,Reader._meta_reader,Kernel._list),Kernel._any,
  	0,_function_(unbind_I_meta_reader,"unbind!_meta_reader"));
  ...
  Reader.load_file->addMethod(list::domain(2,Kernel._string,Kernel._boolean),Kernel._any,
  	NEW_ALLOC,_function_(load_file_string,"load_file_string"));
  
  Reader.load->addMethod(list::domain(1,Kernel._string),Kernel._any,
  	NEW_ALLOC,_function_(load_string,"load_string"));
  
  Reader.sload->addMethod(list::domain(1,Kernel._string),Kernel._any,
  	NEW_ALLOC,_function_(sload_string,"sload_string"));
  
  Reader.load_file->addMethod(list::domain(2,Kernel._module,Kernel._boolean),Kernel._void,
  	NEW_ALLOC+SLOT_UPDATE,_function_(load_file_module,"load_file_module"));
  ...
  Reader.add_modules->addMethod(list::domain(3,Kernel._module,Kernel._set,Kernel._list),Kernel._list,
  	NEW_ALLOC+BAG_UPDATE,_function_(add_modules_module,"add_modules_module"));
  ...
  Reader.show->addMethod(list::domain(1,Kernel._any),Kernel._any,
  	NEW_ALLOC,_function_(show_any,"show_any"));
  ...
  Reader.hashgrow->addMethod(list::domain(2,Kernel._list,Kernel._property),Kernel._list,
  	0,_function_(hashgrow_list,"hashgrow_list"))->inlineDef("lambda[(l:list,hi:property),let l1 := l,l2 := make_list(nth_get(l1, 0) * 2, unknown) in (for x in l1 (if known?(x) hi(l2, x) else false), l2)]");
  ...
  Kernel.float_I->addFloatMethod(list::domain(1,Kernel._string),Kernel._float,
  	NEW_ALLOC,_function_(float_I_string,"float!_string"),_function_(float_I_string_,"float!_string_"));
  ...
  Reader.sqr->addMethod(list::domain(1,Kernel._integer),Kernel._integer,
  	0,_function_(sqr_integer,"sqr_integer"))->inlineDef("lambda[(x:integer),x * x]");
  
  Reader.sqr->addFloatMethod(list::domain(1,Kernel._float),Kernel._float,
  	0,_function_(sqr_float,"sqr_float"),_function_(sqr_float_,"sqr_float_"))->inlineDef("lambda[(x:float),x * x]");
  ...
  Reader.get_from_integer->addMethod(list::domain(2,Kernel._any,Kernel._integer),Kernel._any,
  	NEW_ALLOC+SLOT_UPDATE,_function_(get_from_integer_any,"get_from_integer_any"));
  ...
  Core.spy->addMethod(list::domain(1,Kernel._listargs),Kernel._void,
  	SLOT_UPDATE,_function_(spy_listargs2_Reader,"spy_listargs2_Reader"));
  
  Reader.self_trace->addMethod(list::domain(1,Language._Trace),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(self_trace_Trace,"self_trace_Trace"));
  ...
  Reader.trace_rule->addMethod(list::domain(6,Kernel._relation,
    ...
    Kernel._any),Kernel._void,
  	NEW_ALLOC,_function_(trace_rule_relation,"trace_rule_relation"));
  ...
  Reader.breakpoint->addMethod(list::domain(1,Kernel._void),Kernel._void,
  	NEW_ALLOC+SLOT_UPDATE,_function_(breakpoint_void,"breakpoint_void"));
  ...
  Reader.closure_build->addMethod(list::domain(1,Core._lambda),Kernel._list,
  	BAG_UPDATE,_function_(closure_build_lambda,"closure_build_lambda"));
  
  Reader.closure_build->addMethod(list::domain(2,Kernel._any,Kernel._list),Kernel._void,
  	BAG_UPDATE,_function_(closure_build_any,"closure_build_any"));
  
  Core.call_step->addMethod(list::domain(1,Kernel._property),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(call_step_property_Reader,"call_step_property_Reader"));
  
  Reader.step->addMethod(list::domain(1,Kernel._any),Kernel._void,
  	SLOT_UPDATE,_function_(step_any,"step_any"));
  
  { (Reader._measure = ClaireClass::make("measure",Kernel._object,claire.it));
    CL_ADD_SLOT(Reader._measure,measure,Reader.m_index,m_index,Kernel._integer,1);
    CL_ADD_SLOT(Reader._measure,measure,Reader.sum_value,sum_value,Kernel._float,_float_(0.0));
    CL_ADD_SLOT(Reader._measure,measure,Reader.sum_square,sum_square,Kernel._float,_float_(0.0));
    CL_ADD_SLOT(Reader._measure,measure,Reader.num_value,num_value,Kernel._float,_float_(0.0));
    } 
  
  Kernel.close->addMethod(list::domain(1,Reader._measure),Reader._measure,
  	SAFE_RESULT,_function_(close_measure,"close_measure"));
  
  Kernel.add->addFloatMethod(list::domain(2,Reader._measure,Kernel._float),Reader._measure,
  	NEW_ALLOC+SAFE_RESULT,_function_(add_measure,"add_measure"),_function_(add_measure_,"add_measure_"));
  
  Reader.mean->addFloatMethod(list::domain(1,Reader._measure),Kernel._float,
  	NEW_ALLOC,_function_(mean_measure,"mean_measure"),_function_(mean_measure_,"mean_measure_"));
  
  Reader.stdev->addFloatMethod(list::domain(1,Reader._measure),Kernel._float,
  	NEW_ALLOC,_function_(stdev_measure,"stdev_measure"),_function_(stdev_measure_,"stdev_measure_"));
  
  Reader.stdev_Z->addFloatMethod(list::domain(1,Reader._measure),Kernel._float,
  	NEW_ALLOC,_function_(stdev_Z_measure,"stdev%_measure"),_function_(stdev_Z_measure_,"stdev%_measure_"));
  
  Reader.reset->addMethod(list::domain(1,Reader._measure),Kernel._void,
  	NEW_ALLOC,_function_(reset_measure,"reset_measure"));
  
  Kernel.self_print->addMethod(list::domain(1,Reader._measure),Kernel._void,
  	NEW_ALLOC,_function_(self_print_measure_Reader,"self_print_measure_Reader"));
  
  Reader.logMeasure->addMethod(list::domain(1,Kernel._string),Kernel._void,
  	0,_function_(logMeasure_string,"logMeasure_string"));
  
  Reader.addLog->addFloatMethod(list::domain(5,Kernel._integer,
    Kernel._float,
    Kernel._float,
    Kernel._float,
    Kernel._integer),Kernel._void,
  	0,_function_(addLog_integer,"addLog_integer"),_function_(addLog_integer_,"addLog_integer_"));
  ...
  Reader.dependents->addMethod(list::domain(1,Kernel._any),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(dependents_any,"dependents_any"));
