/***** CLAIRE Compilation of file Optimize.cl 
         [version 3.4.0 / safety 5] Sun Sep 29 07:16:47 2013 *****/
...
// definition of the properties 
  ...
  Optimize.use_string_update = property::make("use_string_update",Compile.it);
  ...
  { global_variable * v2072 = (Optimize.claire_modules = (global_variable *) Core._global_variable->instantiate("claire_modules",claire.it));
    ...
    { global_variable * v11495 = v2072; 
      OID  v11496;
      { list * v13124;{ bag *v_list; OID v_val;
          OID v7248,CLcount;
          ...
          { v7248 = (*(v_list))[CLcount];
            v_val = value_string(string_v(v7248));
            
            (*((list *) v13124))[CLcount] = v_val;} 
          } 
  ...
  { (Optimize.compiler = (Optimize_meta_compiler *) Optimize._meta_compiler->instantiate("compiler",claire.it));
    ...
    (Optimize.compiler->version = _float_(4.0));
    ...
    update_property(Optimize.options,
      ...
      19,
      Kernel._object,
      _oid_(list::alloc(Kernel._any,3,_string_("-c /O2 /Oi"),
        _string_("-c /Zi"),
        _string_("-c /Zi"))));
    ;} 
  ...
  Optimize.c_type->addMethod(list::domain(1,Kernel._any),Kernel._type,
  	NEW_ALLOC,_function_(c_type_any_Optimize,"c_type_any_Optimize"));
  
  Optimize.c_strict_code->addMethod(list::domain(2,Kernel._any,Kernel._class),Kernel._any,
  	NEW_ALLOC,_function_(c_strict_code_any,"c_strict_code_any"));
  
  Optimize.c_strict_check->addMethod(list::domain(2,Kernel._any,Kernel._class),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_strict_check_any_Optimize,"c_strict_check_any_Optimize"));
  ...
  Optimize.c_code->addMethod(list::domain(1,Kernel._any),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_code_any2_Optimize,"c_code_any2_Optimize"));
  
  Optimize.c_gc_ask->addMethod(list::domain(1,Kernel._any),Kernel._boolean,
  	0,_function_(c_gc_ask_any,"c_gc?_any"));
  
  Optimize.c_sort->addMethod(list::domain(1,Kernel._any),Kernel._class,
  	NEW_ALLOC,_function_(c_sort_any_Optimize,"c_sort_any_Optimize"));
  
  Optimize.selector_psort->addMethod(list::domain(1,Language._Call),Kernel._class,
  	0,_function_(selector_psort_Call,"selector_psort_Call"));
  ...
  Optimize.c_status_call->addMethod(list::domain(2,Kernel._property,Kernel._type),Kernel._integer,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_status_call_property,"c_status_call_property"));
  ...
  Optimize.stable_ask->addMethod(list::domain(1,Kernel._relation),Kernel._boolean,
  	SLOT_UPDATE,_function_(stable_ask_relation,"stable?_relation"));
  
  Optimize.get_module->addMethod(list::domain(1,U_type(Kernel._thing,Kernel._class)),Kernel._any,
  	0,_function_(get_module_object,"get_module_object"));
  
  Reader.known_I->addMethod(list::domain(1,Kernel._listargs),Kernel._any,
  	NEW_ALLOC,_function_(known_I_listargs,"known!_listargs"));
  ...
  Optimize.oload->addMethod(list::domain(1,Kernel._string),Kernel._any,
  	NEW_ALLOC,_function_(oload_string,"oload_string"));
  ...
  Optimize.c_type->addMethod(list::domain(1,Optimize._to_CL),Kernel._type,
  	NEW_ALLOC,_function_(c_type_to_CL_Optimize,"c_type_to_CL_Optimize"));
  
  Optimize.c_gc_ask->addMethod(list::domain(1,Optimize._to_CL),Kernel._boolean,
  	BAG_UPDATE+SLOT_UPDATE,_function_(c_gc_ask_to_CL,"c_gc?_to_CL"));
  ...
  Optimize.c_gc_ask->addMethod(list::domain(1,Optimize._to_C),Kernel._boolean,
  	BAG_UPDATE+SLOT_UPDATE,_function_(c_gc_ask_to_C,"c_gc?_to_C"));
  
  Optimize.c_type->addMethod(list::domain(1,Optimize._to_C),Kernel._type,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_type_to_C_Optimize,"c_type_to_C_Optimize"));
  ...
  Optimize.c_gc_ask->addMethod(list::domain(1,Optimize._C_cast),Kernel._boolean,
  	0,_function_(c_gc_ask_C_cast,"c_gc?_C_cast"));
  ...
  Optimize.c_code->addMethod(list::domain(2,Optimize._C_cast,Kernel._class),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_code_C_cast_Optimize,"c_code_C_cast_Optimize"));
  ...
  Optimize.c_warn->addMethod(list::domain(3,Language._Variable,Kernel._any,Kernel._type),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_warn_Variable,"c_warn_Variable"));
  ...
  Optimize.sort_abstract_I->addMethod(list::domain(1,Kernel._type),Kernel._type,
  	NEW_ALLOC,_function_(sort_abstract_I_type,"sort_abstract!_type"));
  ...
  Optimize.return_type->addMethod(list::domain(1,Kernel._any),Kernel._type,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(return_type_any,"return_type_any"));
  
  Optimize.c_code->addMethod(list::domain(2,Core._Type,Kernel._class),Kernel._any,
  	NEW_ALLOC,_function_(c_code_Type_Optimize,"c_code_Type_Optimize"));
  ...
  Optimize.member_code->addMethod(list::domain(2,Kernel._class,Kernel._any),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(member_code_class2,"member_code_class2"));
  ...
  Optimize.member_code->addMethod(list::domain(2,Core._Interval,Kernel._any),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(member_code_Interval,"member_code_Interval"));
  
  Optimize.member_code->addMethod(list::domain(2,Core._Param,Kernel._any),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(member_code_Param,"member_code_Param"));
  
  Optimize.member_code->addMethod(list::domain(2,Kernel._tuple,Kernel._any),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(member_code_tuple,"member_code_tuple"));
  
  Optimize.member_code->addMethod(list::domain(2,Kernel._any,Kernel._any),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(member_code_any,"member_code_any"));
  ...
  Optimize.gcsafe_ask->addMethod(list::domain(1,Kernel._type),Kernel._boolean,
  	0,_function_(gcsafe_ask_type,"gcsafe?_type"));
  
  Optimize.gcsafe_ask->addMethod(list::domain(1,Kernel._property),Kernel._boolean,
  	0,_function_(gcsafe_ask_property,"gcsafe?_property"));
  
  Optimize.c_gc_I->addMethod(list::domain(1,Kernel._any),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_gc_I_any1,"c_gc!_any1"));
  
  Optimize.c_gc_I->addMethod(list::domain(2,Kernel._any,Kernel._type),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_gc_I_any2,"c_gc!_any2"));
  ...
  Optimize.c_inline->addMethod(list::domain(3,Kernel._method,Kernel._list,Kernel._class),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_inline_method1,"c_inline_method1"));
  
  Optimize.c_inline->addMethod(list::domain(2,Kernel._method,Kernel._list),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_inline_method2,"c_inline_method2"));
  
  Optimize.c_inline_arg_ask->addMethod(list::domain(1,Kernel._any),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_inline_arg_ask_any,"c_inline_arg?_any"));
  ...
  Optimize.c_substitution->addMethod(list::domain(4,Kernel._any,
    ...
    Kernel._boolean),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_substitution_any,"c_substitution_any"));
  ...
  Optimize.c_boolean->addMethod(list::domain(1,Kernel._any),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_boolean_any,"c_boolean_any"));
  ...
  Optimize.c_type->addMethod(list::domain(1,Language._Call),Kernel._type,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_type_Call_Optimize,"c_type_Call_Optimize"));
  
  Optimize.c_code->addMethod(list::domain(1,Language._Call),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_code_Call_Optimize,"c_code_Call_Optimize"));
  
  Optimize.c_code_call->addMethod(list::domain(2,Language._Call,Kernel._class),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_code_call_Call,"c_code_call_Call"));
  ...
  Optimize.c_gc_ask->addMethod(list::domain(1,Language._Call),Kernel._boolean,
  	SLOT_UPDATE,_function_(c_gc_ask_Call,"c_gc?_Call"));
  ...
  Optimize.c_gc_ask->addMethod(list::domain(1,Language._Call_slot),Kernel._boolean,
  	0,_function_(c_gc_ask_Call_slot,"c_gc?_Call_slot"));
  ...
  Optimize.c_code_write->addMethod(list::domain(1,Language._Call),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_code_write_Call,"c_code_write_Call"));
  
  Optimize.c_code_hold->addMethod(list::domain(4,Kernel._property,
    Kernel._any,
    Kernel._any,
    Kernel._boolean),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_code_hold_property,"c_code_hold_property"));
  
  Optimize.c_code_add->addMethod(list::domain(1,Language._Call),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_code_add_Call,"c_code_add_Call"));
  
  Optimize.c_code_add_bag->addMethod(list::domain(1,Language._Call),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_code_add_bag_Call,"c_code_add_bag_Call"));
  
  Optimize.c_code_delete->addMethod(list::domain(1,Language._Call),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_code_delete_Call,"c_code_delete_Call"));
  
  Optimize.c_code_not->addMethod(list::domain(1,Language._Select),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_code_not_Select,"c_code_not_Select"));
  
  Optimize.c_code_belong->addMethod(list::domain(1,Language._Call),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_code_belong_Call,"c_code_belong_Call"));
  
  Optimize.c_code_nth->addMethod(list::domain(1,Language._Call),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_code_nth_Call,"c_code_nth_Call"));
  
  Optimize.c_code_table->addMethod(list::domain(1,Language._Call),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_code_table_Call,"c_code_table_Call"));
  
  Optimize.c_code_array->addMethod(list::domain(1,Language._Call),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_code_array_Call,"c_code_array_Call"));
  ...
  Optimize.c_code_method->addMethod(list::domain(3,Kernel._method,Kernel._list,Kernel._list),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_code_method_method1,"c_code_method_method1"));
  
  Optimize.c_code_method->addMethod(list::domain(4,Kernel._method,
    Kernel._list,
    Kernel._list,
    Kernel._class),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_code_method_method2,"c_code_method_method2"));
  ...
  Optimize.c_type->addMethod(list::domain(1,Language._Assign),Kernel._type,
  	NEW_ALLOC,_function_(c_type_Assign_Optimize,"c_type_Assign_Optimize"));
  ...
  Optimize.c_gc_ask->addMethod(list::domain(1,Language._Assign),Kernel._boolean,
  	0,_function_(c_gc_ask_Assign,"c_gc?_Assign"));
  
  Optimize.c_type->addMethod(list::domain(1,Language._Gassign),Kernel._type,
  	NEW_ALLOC,_function_(c_type_Gassign_Optimize,"c_type_Gassign_Optimize"));
  ...
  Optimize.c_gc_ask->addMethod(list::domain(1,Language._Gassign),Kernel._boolean,
  	0,_function_(c_gc_ask_Gassign,"c_gc?_Gassign"));
  ...
  Optimize.c_type->addMethod(list::domain(1,Optimize._to_protect),Kernel._type,
  	NEW_ALLOC,_function_(c_type_to_protect_Optimize,"c_type_to_protect_Optimize"));
  ...
  Optimize.c_type->addMethod(list::domain(1,Language._Handle),Kernel._type,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_type_Handle_Optimize,"c_type_Handle_Optimize"));
  
  Optimize.c_code->addMethod(list::domain(2,Language._Handle,Kernel._class),Kernel._any,
  	NEW_ALLOC,_function_(c_code_Handle_Optimize,"c_code_Handle_Optimize"));
  
  Optimize.c_gc_ask->addMethod(list::domain(1,Language._Handle),Kernel._boolean,
  	0,_function_(c_gc_ask_Handle,"c_gc?_Handle"));
  ...
  Optimize.c_code->addMethod(list::domain(1,Language._Cast),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_code_Cast_Optimize,"c_code_Cast_Optimize"));
  ...
  Optimize.c_code->addMethod(list::domain(1,Language._Super),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_code_Super_Optimize,"c_code_Super_Optimize"));
  ...
  Kernel.self_print->addMethod(list::domain(1,Optimize._Call_function2),Kernel._void,
  	NEW_ALLOC,_function_(self_print_Call_function2,"self_print_Call_function2"));
  ...
  Optimize.c_code->addMethod(list::domain(1,Language._Assert),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_code_Assert_Optimize,"c_code_Assert_Optimize"));
  
  Optimize.c_code->addMethod(list::domain(1,Language._Trace),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_code_Trace_Optimize,"c_code_Trace_Optimize"));
  ...
  Optimize.c_code->addMethod(list::domain(1,Language._Branch),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_code_Branch_Optimize,"c_code_Branch_Optimize"));
  
  Optimize.c_code->addMethod(list::domain(2,Language._Macro,Kernel._class),Kernel._any,
  	NEW_ALLOC,_function_(c_code_Macro_Optimize,"c_code_Macro_Optimize"));
  
  Optimize.c_type->addMethod(list::domain(1,Language._Macro),Kernel._type,
  	NEW_ALLOC,_function_(c_type_Macro_Optimize,"c_type_Macro_Optimize"));
  ...
  Optimize.c_code->addMethod(list::domain(1,Language._Printf),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_code_Printf_Optimize,"c_code_Printf_Optimize"));
  ...
  Optimize.c_gc_ask->addMethod(list::domain(1,Language._If),Kernel._boolean,
  	0,_function_(c_gc_ask_If,"c_gc?_If"));
  ...
  Optimize.c_type->addMethod(list::domain(1,Language._Do),Kernel._type,
  	NEW_ALLOC,_function_(c_type_Do_Optimize,"c_type_Do_Optimize"));
  ...
  Optimize.c_gc_ask->addMethod(list::domain(1,Language._Do),Kernel._boolean,
  	0,_function_(c_gc_ask_Do,"c_gc?_Do"));
  
  Optimize.c_type->addMethod(list::domain(1,Language._Let),Kernel._type,
  	NEW_ALLOC+SLOT_UPDATE,_function_(c_type_Let_Optimize,"c_type_Let_Optimize"));
  ...
  Optimize.c_type->addMethod(list::domain(1,Language._When),Kernel._type,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_type_When_Optimize,"c_type_When_Optimize"));
  
  Optimize.c_code->addMethod(list::domain(2,Language._When,Kernel._class),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_code_When_Optimize,"c_code_When_Optimize"));
  
  Optimize.c_gc_ask->addMethod(list::domain(1,Language._Let),Kernel._boolean,
  	0,_function_(c_gc_ask_Let,"c_gc?_Let"));
  
  Optimize.c_type->addMethod(list::domain(1,Language._For),Kernel._type,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_type_For_Optimize,"c_type_For_Optimize"));
  
  Optimize.infers_from->addMethod(list::domain(2,Kernel._type,Kernel._any),Kernel._type,
  	NEW_ALLOC,_function_(infers_from_type2,"infers_from_type2"));
  ...
  Optimize.c_code_multiple->addMethod(list::domain(3,Language._For,Kernel._type,Kernel._class),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_code_multiple_For,"c_code_multiple_For"));
  ...
  Optimize.c_type->addMethod(list::domain(1,Language._Iteration),Kernel._type,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_type_Iteration_Optimize,"c_type_Iteration_Optimize"));
  
  Optimize.c_code->addMethod(list::domain(1,Language._Iteration),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_code_Iteration_Optimize,"c_code_Iteration_Optimize"));
  ...
  Optimize.c_code->addMethod(list::domain(2,Language._Exists,Kernel._class),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_code_Exists_Optimize,"c_code_Exists_Optimize"));
  
  Optimize.c_type->addMethod(list::domain(1,Language._Image),Kernel._type,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_type_Image_Optimize,"c_type_Image_Optimize"));
  
  Optimize.c_type->addMethod(list::domain(1,Language._Select),Kernel._type,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_type_Select_Optimize,"c_type_Select_Optimize"));
  
  Optimize.c_type->addMethod(list::domain(1,Language._Lselect),Kernel._type,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_type_Lselect_Optimize,"c_type_Lselect_Optimize"));
  
  Optimize.c_type->addMethod(list::domain(1,Language._While),Kernel._type,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_type_While_Optimize,"c_type_While_Optimize"));
  
  Optimize.c_code->addMethod(list::domain(2,Language._While,Kernel._class),Kernel._any,
  	NEW_ALLOC,_function_(c_code_While_Optimize,"c_code_While_Optimize"));
  
  Optimize.Iterate_I->addMethod(list::domain(1,Language._Iteration),Kernel._any,
  	NEW_ALLOC,_function_(Iterate_I_Iteration,"Iterate!_Iteration"));
  ...
  Language.Iterate->addMethod(list::domain(3,nth_property(Kernel._dot_dot,tuple::alloc(2,_oid_(Kernel._integer),_oid_(Kernel._integer))),Language._Variable,Kernel._any),Kernel._any,
  	0,_function_(Iterate_any1,"Iterate_any1"))->inlineDef("lambda[(x:..[tuple(integer,integer)],v:Variable,e:any),let v := eval(x.args[1]),%max := eval(x.args[2]) in while (v <= %max) (e, v := v + 1)]");
  
  Language.Iterate->addMethod(list::domain(3,Language._Lselect,Language._Variable,Kernel._any),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(Iterate_Lselect,"Iterate_Lselect"))->inlineDef("lambda[(x:Lselect,v:Variable,e:any),for v in eval(x.iClaire/set_arg) (if eval(substitution(x.arg, x.var, v)) e else false)]");
  
  Language.Iterate->addMethod(list::domain(3,Language._Select,Language._Variable,Kernel._any),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(Iterate_Select,"Iterate_Select"))->inlineDef("lambda[(x:Select,v:Variable,e:any),for v in eval(x.iClaire/set_arg) (if eval(substitution(x.arg, x.var, v)) e else false)]");
  ...
  Language.Iterate->addMethod(list::domain(3,nth_property(Core.but,tuple::alloc(2,_oid_(Kernel._any),_oid_(Kernel._any))),Language._Variable,Kernel._any),Kernel._any,
  	0,_function_(Iterate_any2,"Iterate_any2"))->inlineDef("lambda[(x:but[tuple(any,any)],v:Variable,e:any),for v in eval(x.args[1]) (if (v != eval(x.args[2])) e else false)]");
  ...
  Language.Iterate->addMethod(list::domain(3,nth_property(Kernel._7_plus,tuple::alloc(2,_oid_(Kernel._any),_oid_(Kernel._any))),Language._Variable,Kernel._any),Kernel._any,
  	RETURN_ARG,_function_(Iterate_any3,"Iterate_any3"))->inlineDef("lambda[(x:/+[tuple(any,any)],v:Variable,e:any),(for v in eval(x.args[1]) e, for v in eval(x.args[2]) e)]");
  
  Optimize.c_type->addMethod(list::domain(1,Language._List),Kernel._type,
  	NEW_ALLOC,_function_(c_type_List_Optimize,"c_type_List_Optimize"));
  
  Optimize.c_code->addMethod(list::domain(1,Language._List),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_code_List_Optimize,"c_code_List_Optimize"));
  
  Optimize.c_type->addMethod(list::domain(1,Language._Set),Kernel._type,
  	NEW_ALLOC,_function_(c_type_Set_Optimize,"c_type_Set_Optimize"));
  
  Optimize.c_code->addMethod(list::domain(1,Language._Set),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_code_Set_Optimize,"c_code_Set_Optimize"));
  ...
  Optimize.c_code->addMethod(list::domain(1,Language._Tuple),Kernel._any,
  	NEW_ALLOC,_function_(c_code_Tuple_Optimize,"c_code_Tuple_Optimize"));
  ...
  Optimize.c_code->addMethod(list::domain(2,Language._Definition,Kernel._class),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_code_Definition_Optimize,"c_code_Definition_Optimize"));
  ...
  Optimize.c_code->addMethod(list::domain(1,Language._Defmethod),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_code_Defmethod_Optimize,"c_code_Defmethod_Optimize"));
  ...
  Optimize.sort_code->addMethod(list::domain(2,Language._Defmethod,Kernel._list),Kernel._any,
  	NEW_ALLOC,_function_(sort_code_Defmethod,"sort_code_Defmethod"));
  ...
  Optimize.c_code->addMethod(list::domain(1,Language._Defarray),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_code_Defarray_Optimize,"c_code_Defarray_Optimize"));
  ...
  Optimize.Produce_put->addMethod(list::domain(3,Kernel._property,Language._Variable,Kernel._any),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(Produce_put_property2,"Produce_put_property2"));
  
  Optimize.Produce_erase->addMethod(list::domain(2,Kernel._property,Language._Variable),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(Produce_erase_property2,"Produce_erase_property2"));
  ...
  Optimize.Produce_get->addMethod(list::domain(2,Kernel._relation,Language._Variable),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(Produce_get_relation2,"Produce_get_relation2"));
  
  Optimize.Produce_remove->addMethod(list::domain(3,Kernel._property,Language._Variable,Kernel._any),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(Produce_remove_property2,"Produce_remove_property2"));
  ...
  Optimize.c_code->addMethod(list::domain(2,Language._Defrule,Kernel._class),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_code_Defrule_Optimize,"c_code_Defrule_Optimize"));
  
  Optimize.compile_if_write->addMethod(list::domain(1,Kernel._relation),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(compile_if_write_relation,"compile_if_write_relation"));
  
  Optimize.compileEventMethod->addMethod(list::domain(1,Kernel._property),Kernel._any,
  	NEW_ALLOC,_function_(compileEventMethod_property,"compileEventMethod_property"));
