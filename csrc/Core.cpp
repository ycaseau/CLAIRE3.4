...
// definition of the properties 
  ...
  Core.printFDigit = property::make("printFDigit",mClaire.it);
  Core.sin = property::make("sin",claire.it);
  Core.cos = property::make("cos",claire.it);
  Core.abs = property::make("abs",claire.it);
  ...
  Core.inlineok_ask->addMethod(list::domain(2,Kernel._method,Kernel._string),Kernel._method,
  	NEW_ALLOC+SAFE_RESULT,_function_(inlineok_ask_method,"inlineok?_method"));
  ...
  Kernel.put->addMethod(list::domain(3,Kernel._slot,Kernel._object,Kernel._any),Kernel._any,
  	SLOT_UPDATE,_function_(put_slot,"put_slot"));
  
  Kernel.get->addMethod(list::domain(2,Kernel._property,Kernel._object),Kernel._any,
  	0,_function_(get_property,"get_property"));
  ...
  Kernel.put->addMethod(list::domain(5,Kernel._property,
    ...
    Kernel._any),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(put_property1,"put_property1"));
  ...
  Core.update_plus->addMethod(list::domain(3,Kernel._relation,Kernel._any,Kernel._any),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(update_plus_relation,"update+_relation"));
  
  Core.update_dash->addMethod(list::domain(3,Kernel._relation,Kernel._any,Kernel._any),Kernel._void,
  	BAG_UPDATE+SLOT_UPDATE,_function_(update_dash_relation,"update-_relation"));
  
  Kernel.add_I->addMethod(list::domain(4,Kernel._property,
    Kernel._object,
    Kernel._integer,
    Kernel._any),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(add_I_property,"add!_property"));
  ...
  Core.known_ask->addMethod(list::domain(2,Kernel._property,Kernel._object),Kernel._boolean,
  	0,_function_(known_ask_property,"known?_property"));
  
  Core.unknown_ask->addMethod(list::domain(2,Kernel._property,Kernel._object),Kernel._boolean,
  	0,_function_(unknown_ask_property,"unknown?_property"));
  ...
  Core.set_range->addMethod(list::domain(3,Kernel._property,Kernel._class,Kernel._type),Kernel._void,
  	SLOT_UPDATE,_function_(set_range_property,"set_range_property"));
  
  Core.put_store->addMethod(list::domain(4,Kernel._property,
    Kernel._object,
    Kernel._any,
    Kernel._boolean),Kernel._void,
  	NEW_ALLOC+SLOT_UPDATE,_function_(put_store_property2,"put_store_property2"));
  ...
  Core.insert_definition->addMethod(list::domain(2,Kernel._property,Kernel._restriction),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(insert_definition_property,"insert_definition_property"));
  
  Core.initialize->addMethod(list::domain(3,Kernel._restriction,Kernel._class,Kernel._list),Kernel._list,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(initialize_restriction1,"initialize_restriction1"));
  ...
  Core.initialize->addMethod(list::domain(2,Kernel._restriction,Kernel._list),Kernel._list,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(initialize_restriction2,"initialize_restriction2"));
  
  Core.hashinsert->addMethod(list::domain(1,Kernel._restriction),Kernel._any,
  	BAG_UPDATE+SLOT_UPDATE,_function_(hashinsert_restriction,"hashinsert_restriction"));
  
  Core.hashinsert->addMethod(list::domain(2,Kernel._class,Kernel._method),Kernel._any,
  	BAG_UPDATE+SLOT_UPDATE,_function_(hashinsert_class,"hashinsert_class"));
  
  Core.hashinsert->addMethod(list::domain(2,Kernel._list,Kernel._method),Kernel._any,
  	NEW_ALLOC+BAG_UPDATE,_function_(hashinsert_list,"hashinsert_list"));
  
  Core.hashget->addMethod(list::domain(2,Kernel._class,Kernel._property),Kernel._object,
  	0,_function_(hashget_class,"hashget_class"));
  ...
  Core._at->addMethod(list::domain(2,Kernel._property,Kernel._class),Kernel._object,
  	0,_function_(_at_property1,"@_property1"));
  ...
  Core.find_which->addMethod(list::domain(3,Kernel._property,Kernel._integer,Kernel._class),Kernel._object,
  	0,_function_(find_which_property,"find_which_property"));
  ...
  Kernel.put->addMethod(list::domain(3,Kernel._property,Kernel._object,Kernel._any),Kernel._any,
  	NEW_ALLOC+SLOT_UPDATE,_function_(put_property2,"put_property2"));
  ...
  Kernel._delete->addMethod(list::domain(3,Kernel._table,Kernel._any,Kernel._any),Kernel._any,
  	BAG_UPDATE+SLOT_UPDATE,_function_(delete_table,"delete_table"));
  ...
  Kernel.nth_equal->addMethod(list::domain(4,Kernel._table,
    ...
    Kernel._any,
    Kernel._any),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(nth_equal_table2,"nth=_table2"));
  ...
  Core.erase->addMethod(list::domain(1,Kernel._table),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE,_function_(erase_table,"erase_table"));
  
  Core.make_table->addMethod(list::domain(3,Kernel._type,Kernel._type,Kernel._any),Kernel._table,
  	NEW_ALLOC,_function_(make_table_type,"make_table_type"));
  ...
  Core.domain_I->addMethod(list::domain(1,Kernel._restriction),Kernel._class,
  	0,_function_(domain_I_restriction,"domain!_restriction"));
  ...
  Core.reify->addMethod(list::domain(1,Kernel._listargs),Kernel._void,
  	0,_function_(reify_listargs,"reify_listargs"));
  ...
  Kernel.self_print->addMethod(list::domain(1,Core._general_error),Kernel._void,
  	NEW_ALLOC,_function_(self_print_general_error_Core,"self_print_general_error_Core"));
  ...
  Kernel.self_print->addMethod(list::domain(1,Kernel._system_error),Kernel._void,
  	NEW_ALLOC,_function_(self_print_system_error_Core,"self_print_system_error_Core"));
  ...
  { global_variable * _CL_obj = (Core.claire_date = (global_variable *) Core._global_variable->instantiate("claire_date",claire.it));
    ...
    (_CL_obj->value = _string_("Sun Sep 29 07:16:30 2013\n"));
    close_global_variable(_CL_obj);
    } 
  ...
  Core.print_in_string->addMethod(list::domain(1,Kernel._void),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(print_in_string_void,"print_in_string_void"));
  ...
  Core.apply_self_print->addMethod(list::domain(1,Kernel._any),Kernel._void,
  	NEW_ALLOC+SLOT_UPDATE,_function_(apply_self_print_any,"apply_self_print_any"));
  ...
  Core.complete_I->addMethod(list::domain(1,Kernel._object),Kernel._object,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(complete_I_object,"complete_I_object"));
  ...
  Core.check_in->addMethod(list::domain(2,Kernel._any,Kernel._type),Kernel._any,
  	0,_function_(check_in_any,"check_in_any"));
  ...
  Kernel.ephemeral->addMethod(list::domain(1,Kernel._class),Kernel._any,
  	SLOT_UPDATE,_function_(ephemeral_class,"ephemeral_class"));
  ...
  Kernel.FINAL->addMethod(list::domain(1,Kernel._class),Kernel._any,
  	SAFE_RESULT,_function_(final_class,"final_class"));
  
  (Core.NEW->addMethod(list::domain(1,Kernel._class),Kernel._object,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(new_class1,"new_class1"))->typing = _oid_(_function_(new_class1_type,"new_class1_type")));
  
  (Core.NEW->addMethod(list::domain(2,Kernel._class,Kernel._symbol),Kernel._thing,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(new_class2,"new_class2"))->typing = _oid_(_function_(new_class2_type,"new_class2_type")));
  ...
  Core.meet->addMethod(list::domain(2,Kernel._class,Kernel._class),Kernel._class,
  	0,_function_(meet_class,"meet_class"));
  ...
  Kernel.FINAL->addMethod(list::domain(1,Kernel._relation),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(final_relation,"final_relation"));
  ...
  Kernel.store->addMethod(list::domain(1,Kernel._listargs),Kernel._any,
  	0,_function_(store_listargs,"store_listargs"));
  ...
  Kernel.nth_get->addMethod(list::domain(3,Kernel._string,Kernel._integer,Kernel._integer),Kernel._char,
  	0,_function_(nth_get_string,"nth_get_string"));
  
  Kernel.nth_put->addMethod(list::domain(4,Kernel._string,
    Kernel._integer,
    Kernel._char,
    Kernel._integer),Kernel._void,
  	STRING_UPDATE,_function_(nth_put_string,"nth_put_string"));
  ...
  Kernel.self_print->addMethod(list::domain(1,Kernel._symbol),Kernel._void,
  	NEW_ALLOC,_function_(self_print_symbol_Core,"self_print_symbol_Core"));
  ...
  Core.abs->addMethod(list::domain(1,Kernel._integer),Kernel._integer,
  	0,_function_(abs_integer,"abs_integer"));
  
  Kernel.random->addMethod(list::domain(2,Kernel._integer,Kernel._integer),Kernel._integer,
  	0,_function_(random_integer2,"random_integer2"));
  ...
  (Core.pair_1->addMethod(list::domain(1,Kernel._list),Kernel._any,
  	0,_function_(pair_1_list,"pair_1_list"))->typing = _oid_(_function_(pair_1_list_type,"pair_1_list_type")));
  
  (Core.pair_2->addMethod(list::domain(1,Kernel._list),Kernel._any,
  	0,_function_(pair_2_list,"pair_2_list"))->typing = _oid_(_function_(pair_2_list_type,"pair_2_list_type")));
  ...
  Core.sin->addFloatMethod(list::domain(1,Kernel._float),Kernel._float,
  	NEW_ALLOC,_function_(sin_float,"sin_float"),_function_(sin_float_,"sin_float_"));
  
  Core.cos->addFloatMethod(list::domain(1,Kernel._float),Kernel._float,
  	NEW_ALLOC,_function_(cos_float,"cos_float"),_function_(cos_float_,"cos_float_"));
  ...
  Core.abs->addFloatMethod(list::domain(1,Kernel._float),Kernel._float,
  	NEW_ALLOC,_function_(abs_float,"abs_float"),_function_(abs_float_,"abs_float_"));
  
  Core.printFDigit->addFloatMethod(list::domain(2,Kernel._float,Kernel._integer),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(printFDigit_float,"printFDigit_float"),_function_(printFDigit_float_,"printFDigit_float_"));
  
  Core.printFDigit->addMethod(list::domain(2,Kernel._integer,Kernel._integer),Kernel._void,
  	SLOT_UPDATE,_function_(printFDigit_integer,"printFDigit_integer"));
  ...
  (Kernel.random->addMethod(list::domain(1,Kernel._bag),Kernel._any,
  	0,_function_(random_bag,"random_bag"))->typing = _oid_(_function_(random_bag_type,"random_bag_type")));
  
  (Core.last->addMethod(list::domain(1,Kernel._list),Kernel._any,
  	0,_function_(last_list,"last_list"))->typing = _oid_(_function_(last_list_type,"last_list_type")));
  ...
  Kernel.nth_equal->addMethod(list::domain(3,Kernel._list,Kernel._integer,Kernel._any),Kernel._any,
  	BAG_UPDATE,_function_(nth_set_list,"nth_set_list"));
  
  Core.car->addMethod(list::domain(1,Kernel._list),Kernel._any,
  	0,_function_(car_list,"car_list"));
  ...
  Core.sort->addMethod(list::domain(2,Kernel._method,Kernel._list),Kernel._list,
  	RETURN_ARG,_function_(sort_method,"sort_method"));
  
  Core.quicksort->addMethod(list::domain(4,Kernel._list,
    Kernel._method,
    Kernel._integer,
    Kernel._integer),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(quicksort_list,"quicksort_list"));
  ...
  Core.make_copy_list->addMethod(list::domain(2,Kernel._integer,Kernel._any),Kernel._list,
  	NEW_ALLOC,_function_(make_copy_list_integer,"make_copy_list_integer"));
  ...
  Kernel.nth_equal->addMethod(list::domain(3,Kernel._array,Kernel._integer,Kernel._any),Kernel._void,
  	0,_function_(nth_equal_array,"nth=_array"));
  ...
  Kernel.random->addMethod(list::domain(1,Kernel._boolean),Kernel._boolean,
  	0,_function_(random_boolean,"random_boolean"));
  ...
  Core.finite_ask->addMethod(list::domain(1,Kernel._type),Kernel._boolean,
  	0,_function_(finite_ask_type,"finite?_type"));
  
  Core.enumerate->addMethod(list::domain(1,Kernel._any),Kernel._bag,
  	NEW_ALLOC,_function_(enumerate_any,"enumerate_any"));
  ...
  Kernel.sort_I->addMethod(list::domain(1,Kernel._type),Kernel._class,
  	0,_function_(sort_I_type,"sort!_type"));
  ...
  Core.finite_ask->addMethod(list::domain(1,Core._Union),Kernel._boolean,
  	0,_function_(finite_ask_Union,"finite?_Union"));
  ...
  Core.finite_ask->addMethod(list::domain(1,Core._Param),Kernel._boolean,
  	0,_function_(finite_ask_Param,"finite?_Param"));
  ...
  Core.finite_ask->addMethod(list::domain(1,Core._subtype),Kernel._boolean,
  	0,_function_(finite_ask_subtype,"finite?_subtype"));
  ...
  Kernel.nth->addMethod(list::domain(3,Kernel._class,Kernel._list,Kernel._list),Kernel._type,
  	NEW_ALLOC+SLOT_UPDATE,_function_(nth_class2,"nth_class2"));
  ...
  Core.finite_ask->addMethod(list::domain(1,Kernel._tuple),Kernel._boolean,
  	0,_function_(finite_ask_tuple,"finite?_tuple"));
  ...
  Kernel.set_I->addMethod(list::domain(1,Kernel._class),Kernel._set,
  	NEW_ALLOC,_function_(set_I_class,"set!_class"));
  ...
  Kernel.set_I->addMethod(list::domain(1,Core._Interval),Kernel._set,
  	0,_function_(set_I_Interval,"set!_Interval"));
  ...
  Core.class_I->addMethod(list::domain(1,Kernel._type),Kernel._class,
  	0,_function_(class_I_type,"class!_type"));
  ...
  Core.U->addMethod(list::domain(2,Kernel._type,Kernel._type),Kernel._type,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(U_type,"U_type"));
  ...
  Core.glb->addMethod(list::domain(2,Core._Union,Kernel._type),Kernel._type,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(glb_Union,"glb_Union"));
  
  Core.glb->addMethod(list::domain(2,Core._Interval,Kernel._type),Kernel._type,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(glb_Interval,"glb_Interval"));
  
  Core.glb->addMethod(list::domain(2,Kernel._class,Kernel._type),Kernel._type,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(glb_class,"glb_class"));
  
  Core.glb->addMethod(list::domain(2,Core._Param,Kernel._type),Kernel._type,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(glb_Param,"glb_Param"));
  
  Core.glb->addMethod(list::domain(2,Core._subtype,Kernel._type),Kernel._type,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(glb_subtype,"glb_subtype"));
  
  Core.glb->addMethod(list::domain(2,Kernel._tuple,Kernel._type),Kernel._type,
  	NEW_ALLOC,_function_(glb_tuple,"glb_tuple"));
  ...
  Kernel._exp->addMethod(list::domain(2,Kernel._type,Kernel._type),Kernel._type,
  	NEW_ALLOC,_function_(_exp_type,"^_type"));
  ...
  Core.member->addMethod(list::domain(1,Kernel._type),Kernel._type,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(member_type,"member_type"));
  
  Core.of_extract->addMethod(list::domain(1,Kernel._type),Kernel._type,
  	0,_function_(of_extract_type,"of_extract_type"));
  
  Core._at->addMethod(list::domain(2,Kernel._type,Kernel._property),Kernel._type,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(_at_type,"@_type"));
  ...
  Core.the->addMethod(list::domain(1,Kernel._type),Kernel._any,
  	NEW_ALLOC,_function_(the_type,"the_type"));
  ...
  Core.abstract_type->addMethod(list::domain(3,Kernel._operation,Kernel._type,Kernel._type),Kernel._type,
  	BAG_UPDATE+SLOT_UPDATE,_function_(abstract_type_operation,"abstract_type_operation"));
  
  { set_range_property(Kernel.subclass,Kernel._class,nth_class2(Kernel._set,list::alloc(Kernel._any,1,_oid_(Kernel.of)),list::alloc(1,_oid_(set::alloc(1,_oid_(Kernel._class))))));
    set_range_property(Kernel.ancestors,Kernel._class,nth_class2(Kernel._list,list::alloc(Kernel._any,1,_oid_(Kernel.of)),list::alloc(1,_oid_(set::alloc(1,_oid_(Kernel._class))))));
    set_range_property(Kernel.descendents,Kernel._class,nth_class2(Kernel._set,list::alloc(Kernel._any,1,_oid_(Kernel.of)),list::alloc(1,_oid_(set::alloc(1,_oid_(Kernel._class))))));
    set_range_property(Kernel.definition,Kernel._property,nth_class2(Kernel._list,list::alloc(Kernel._any,1,_oid_(Kernel.of)),list::alloc(1,_oid_(set::alloc(1,_oid_(Kernel._restriction))))));
    set_range_property(Kernel.restrictions,Kernel._property,nth_class2(Kernel._list,list::alloc(Kernel._any,1,_oid_(Kernel.of)),list::alloc(1,_oid_(set::alloc(1,_oid_(Kernel._restriction))))));
    set_range_property(Kernel.domain,Kernel._restriction,nth_class2(Kernel._list,list::alloc(Kernel._any,1,_oid_(Kernel.of)),list::alloc(1,_oid_(set::alloc(1,_oid_(Kernel._type))))));
    set_range_property(Kernel.slots,Kernel._class,nth_class2(Kernel._list,list::alloc(Kernel._any,1,_oid_(Kernel.of)),list::alloc(1,_oid_(set::alloc(1,_oid_(Kernel._slot))))));
    } 
  ...
  Core.meet_arg_types->addMethod(list::domain(2,Kernel._type,Kernel._type),Kernel._type,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(meet_arg_types_type,"meet_arg_types_type"));
  
  Core.first_member_type->addMethod(list::domain(2,Kernel._type,Kernel._type),Kernel._type,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(first_member_type_type,"first_member_type_type"));
  
  (Kernel.nth->addMethod(list::domain(2,Kernel._array,Kernel._integer),Kernel._any,
  	0,_function_(nth_array,"nth_array"))->typing = _oid_(_function_(nth_array_type,"nth_array_type")));
  ...
  (Core.make_set->addMethod(list::domain(1,nth_class2(Kernel._array,list::alloc(Kernel._any,1,_oid_(Kernel.of)),list::alloc(Kernel.emptySet,1,_oid_(Kernel._any)))),Kernel._set,
  	NEW_ALLOC,_function_(make_set_array,"make_set_array"))->typing = _oid_(_function_(make_set_array_type,"make_set_array_type")));
