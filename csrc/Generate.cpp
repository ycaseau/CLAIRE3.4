...
// definition of the properties 
  ...
  Generate.c_test->addMethod(list::domain(1,Kernel._method),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(c_test_method,"c_test_method"));
  ...
  Generate.generate_files->addMethod(list::domain(1,Kernel._module),Kernel._void,
  	NEW_ALLOC,_function_(generate_files_module,"generate_files_module"));
  
  Generate.generate_f2f->addMethod(list::domain(1,Kernel._module),Kernel._void,
  	NEW_ALLOC,_function_(generate_f2f_module,"generate_f2f_module"));
  ...
  Generate.getRange->addMethod(list::domain(1,Core._global_variable),Kernel._class,
  	0,_function_(getRange_global_variable,"getRange_global_variable"));
  
  Generate.generate_functions->addMethod(list::domain(1,Kernel._module),Kernel._void,
  	NEW_ALLOC,_function_(generate_functions_module,"generate_functions_module"));
  ...
  Generate.print_body->addMethod(list::domain(5,Language._If,
    ...
    Kernel._boolean),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(print_body_If,"print_body_If"));
  ...
  Generate.check_sort->addMethod(list::domain(1,Kernel._method),Kernel._class,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(check_sort_method,"check_sort_method"));
  ...
  Generate.need_debug_ask->addMethod(list::domain(1,Kernel._any),Kernel._boolean,
  	0,_function_(need_debug_ask_any,"need_debug?_any"));
  
  Generate.get_dependents->addMethod(list::domain(1,Kernel._method),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(get_dependents_method,"get_dependents_method"));
  ...
  Generate.expression->addMethod(list::domain(2,Kernel._string,Kernel._any),Kernel._void,
  	0,_function_(expression_string,"expression_string"));
  ...
  Generate.expression->addMethod(list::domain(2,Language._Tuple,Kernel._any),Kernel._void,
  	0,_function_(expression_Tuple,"expression_Tuple"));
  ...
  Generate.expression->addMethod(list::domain(2,Language._List,Kernel._any),Kernel._void,
  	0,_function_(expression_List,"expression_List"));
  ...
  Generate.expression->addMethod(list::domain(2,Optimize._to_protect,Kernel._any),Kernel._void,
  	0,_function_(expression_to_protect,"expression_to_protect"));
  
  Generate.expression->addMethod(list::domain(2,Language._Gassign,Kernel._any),Kernel._void,
  	0,_function_(expression_Gassign,"expression_Gassign"));
  ...
  Optimize.bool_exp->addMethod(list::domain(3,Optimize._to_CL,Kernel._boolean,Kernel._any),Kernel._void,
  	NEW_ALLOC,_function_(bool_exp_to_CL_Generate,"bool_exp_to_CL_Generate"));
  ...
  { (Generate.C_plus_plusPRODUCER = (Generate_c_producer *) Generate._c_producer->instantiate("C++PRODUCER",Generate.it));
    ...
    { Generate_c_producer * v6876 = Generate.C_plus_plusPRODUCER; 
      ...
      { GC_ANY(v6878= list::empty(Kernel.emptySet));
        ...
        ((list *) v6878)->addFast(_oid_(symbol_I_string2("error")));
        ((list *) v6878)->addFast(_oid_(symbol_I_string2("register")));
        ((list *) v6878)->addFast(_oid_(symbol_I_string2("template")));
        ((list *) v6878)->addFast(_oid_(symbol_I_string2("STRING_UPDATE")));} 
      (v6876->bad_names = v6878);} 
    { Generate_c_producer * v6879 = Generate.C_plus_plusPRODUCER; 
      list * v6880;
      { GC_ANY(v6880= list::empty(Kernel.emptySet));
        ((list *) v6880)->addFast(_oid_(symbol_I_string2("DO")));
        ((list *) v6880)->addFast(_oid_(symbol_I_string2("IF")));
        ((list *) v6880)->addFast(_oid_(symbol_I_string2("ClaireAnd")));
        ((list *) v6880)->addFast(_oid_(symbol_I_string2("ClaireOr")));
        ((list *) v6880)->addFast(_oid_(symbol_I_string2("NOT")));
        ((list *) v6880)->addFast(_oid_(symbol_I_string2("PRINTF")));
        ((list *) v6880)->addFast(_oid_(symbol_I_string2("ClaireVoid")));
        ((list *) v6880)->addFast(_oid_(symbol_I_string2("ClairePattern")));
        ((list *) v6880)->addFast(_oid_(symbol_I_string2("ClaireException")));
        ((list *) v6880)->addFast(_oid_(symbol_I_string2("RETURN")));
        ((list *) v6880)->addFast(_oid_(symbol_I_string2("NEW")));
        ((list *) v6880)->addFast(_oid_(symbol_I_string2("ClaireClass")));
        ((list *) v6880)->addFast(_oid_(symbol_I_string2("PRIVATE")));
        ((list *) v6880)->addFast(_oid_(symbol_I_string2("ClaireOperator")));
        ((list *) v6880)->addFast(_oid_(symbol_I_string2("DEFAULT")));
        ((list *) v6880)->addFast(_oid_(symbol_I_string2("ClaireHandle")));
        ((list *) v6880)->addFast(_oid_(symbol_I_string2("ClaireImport")));
        ((list *) v6880)->addFast(_oid_(symbol_I_string2("CATCH")));
        ((list *) v6880)->addFast(_oid_(symbol_I_string2("STDOUT")));
        ((list *) v6880)->addFast(_oid_(symbol_I_string2("STDIN")));
        ((list *) v6880)->addFast(_oid_(symbol_I_string2("BREAK")));
        ((list *) v6880)->addFast(_oid_(symbol_I_string2("ClaireChar")));
        ((list *) v6880)->addFast(_oid_(symbol_I_string2("ClaireInterface")));
        ((list *) v6880)->addFast(_oid_(symbol_I_string2("_eof")));
        ((list *) v6880)->addFast(_oid_(symbol_I_string2("ClaireRelation")));
        ((list *) v6880)->addFast(_oid_(symbol_I_string2("Core")));
        ((list *) v6880)->addFast(_oid_(symbol_I_string2("ClaireObject")));
        ((list *) v6880)->addFast(_oid_(symbol_I_string2("_delete")));
        ((list *) v6880)->addFast(_oid_(symbol_I_string2("ClaireBoolean")));
        ((list *) v6880)->addFast(_oid_(symbol_I_string2("ClaireFunction")));
        ((list *) v6880)->addFast(_oid_(symbol_I_string2("ClaireType")));
        ((list *) v6880)->addFast(_oid_(symbol_I_string2("SystemThing")));
        ((list *) v6880)->addFast(_oid_(symbol_I_string2("ClaireEnvironment")));
        ((list *) v6880)->addFast(_oid_(symbol_I_string2("ABSTRACT")));
        ((list *) v6880)->addFast(_oid_(symbol_I_string2("FINAL")));
        ((list *) v6880)->addFast(_oid_(symbol_I_string2("SystemObject")));
        ((list *) v6880)->addFast(_oid_(symbol_I_string2("_NEW_ALLOC")));
        ((list *) v6880)->addFast(_oid_(symbol_I_string2("_BAG_UPDATE")));
        ((list *) v6880)->addFast(_oid_(symbol_I_string2("_SLOT_UPDATE")));
        ((list *) v6880)->addFast(_oid_(symbol_I_string2("_RETURN_ARG")));
        ((list *) v6880)->addFast(_oid_(symbol_I_string2("_SAFE_RESULT")));
        ((list *) v6880)->addFast(_oid_(symbol_I_string2("_SAFE_GC")));
        ((list *) v6880)->addFast(_oid_(symbol_I_string2("ClaireCollection")));
        ((list *) v6880)->addFast(_oid_(symbol_I_string2("ClaireError")));
        ((list *) v6880)->addFast(_oid_(symbol_I_string2("ClaireRegister")));
        ((list *) v6880)->addFast(_oid_(symbol_I_string2("ClaireTemplate")));
        ((list *) v6880)->addFast(_oid_(symbol_I_string2("_STRING_UPDATE")));} 
      (v6879->good_names = v6880);} 
  ...
  Generate.global_var_def_I->addMethod(list::domain(3,Generate._c_producer,Kernel._module,Language._Let),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(global_var_def_I_c_producer,"global_var_def!_c_producer"));
  ...
  Generate.update_function_entry->addMethod(list::domain(4,Generate._c_producer,
    ...
    Kernel._class),Kernel._any,
  	NEW_ALLOC,_function_(update_function_entry_c_producer,"update_function_entry_c_producer"));
  
  Optimize.c_interface->addMethod(list::domain(1,Kernel._class),Kernel._string,
  	0,_function_(c_interface_class1_Generate,"c_interface_class1_Generate"));
  
  Optimize.c_interface->addMethod(list::domain(2,Kernel._class,Kernel._string),Kernel._void,
  	0,_function_(c_interface_class2_Generate,"c_interface_class2_Generate"));
  ...
  Generate.to_cl->addMethod(list::domain(4,Generate._c_producer,
    ...
    Kernel._class,
    Kernel._any),Kernel._void,
  	NEW_ALLOC,_function_(to_cl_c_producer,"to_cl_c_producer"));
  
  Generate.to_c->addMethod(list::domain(4,Generate._c_producer,
    Kernel._any,
    Kernel._class,
    Kernel._any),Kernel._void,
  	NEW_ALLOC,_function_(to_c_c_producer1,"to_c_c_producer1"));
  ...
  Generate.generate_s_file->addMethod(list::domain(3,Kernel._string,Kernel._list,Kernel._any),Kernel._void,
  	NEW_ALLOC+SLOT_UPDATE,_function_(generate_s_file_string,"generate_s_file_string"));
  ...
  Generate.inline_exp->addMethod(list::domain(3,Generate._c_producer,Language._Call_method1,Kernel._any),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(inline_exp_c_producer1,"inline_exp_c_producer1"));
  
  Generate.inline_exp->addMethod(list::domain(3,Generate._c_producer,Language._Call_method2,Kernel._any),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(inline_exp_c_producer2,"inline_exp_c_producer2"));
  
  Generate.inline_exp->addMethod(list::domain(3,Generate._c_producer,Language._Call_method,Kernel._any),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(inline_exp_c_producer3,"inline_exp_c_producer3"));
  
  Generate.print_external_call->addMethod(list::domain(3,Generate._c_producer,Language._Call_method,Kernel._any),Kernel._void,
  	NEW_ALLOC+BAG_UPDATE+SLOT_UPDATE,_function_(print_external_call_c_producer,"print_external_call_c_producer"));
  
  Generate.inline_exp->addMethod(list::domain(3,Generate._c_producer,Language._Call,Kernel._any),Kernel._void,
  	NEW_ALLOC+SLOT_UPDATE,_function_(inline_exp_c_producer5,"inline_exp_c_producer5"));
  ...
  { global_variable * v2072 = (Generate.bitvectorList = (global_variable *) Core._global_variable->instantiate("bitvectorList",Compile.it));
    (v2072->range = Kernel.emptySet);
    (v2072->value = _oid_(list::alloc(7,_string_("NEW_ALLOC"),
      _string_("BAG_UPDATE"),
  ...
  Generate.getC->addMethod(list::domain(1,Kernel._any),Kernel._any,
  	NEW_ALLOC,_function_(getC_any,"getC_any"));
  ...
  Generate.exp_to_protect->addMethod(list::domain(3,Generate._c_producer,Optimize._to_protect,Kernel._any),Kernel._void,
  	NEW_ALLOC,_function_(exp_to_protect_c_producer,"exp_to_protect_c_producer"));
